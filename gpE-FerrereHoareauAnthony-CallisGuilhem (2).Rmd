...
Ce clutering en deux classes, visible sur `la figure` \ref{fig:ClustExpT}}, nous permet de voir avec plus de précision le comportement des trois traitements, divisés en deux grandes classes. L'une regroupe les gènes dont l'expression au cours du temps suit le comportement des traitements 2 et 3, et l'autre regroupe les gènes dont l'expression suit le comportement du traitement 1.
...
De plus, lors de l'analyse des expressions des gènes, nous avions déjà pu déduire, dans la partie bi-dimensionnelle sur les variables qualitatives, que le traitement 1 serait moins efficace que les autres, notamment en raison du grand nombre de gènes non exprimés au bout de six heures. Par la suite, grâce à l'ACP, au clustering basé sur les moyennes d'expression des réplicats de chaque gène et au diagramme alluvial, nous avons observé une corrélation entre le clustering et l'expression des gènes selon le traitement. Ce diagramme nous a permis de conclure que, bien que le traitement 1 ne soit pas aussi efficace que les traitements 2 et 3, il reste pertinent dans certains cas, notamment pour les gènes appartenant aux clusters ExpMoy2 et ExpMoy4.
