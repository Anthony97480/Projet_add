...
Menez une analyse en composantes principales où les Tt sH Rr sont les individus d´ecrits par les gènes.
...
DataExpMoyCR <- scale(t(DataExpMoy), center=TRUE, scale=T)
# On fait la transposée pour avoir : les Tt_sH_Rr décrits par les gènes (J'avour je suis pas sûr à 100% pour ce passage. Sinon on peut enlever la transposée)
